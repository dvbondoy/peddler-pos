...
'use strict';
  ...
  ItemsController.$inject = ['$scope', 'Items', '$ionicModal'];
  function ItemsController($scope, Items, $ionicModal) {
    var vm = this;
    $scope.item = {};

    $ionicModal.fromTemplateUrl('product/templates/new-item.html', {
      scope: $scope,
      animation: 'slide-in-up'
    }).then(function(modal) {
